export const aboutIntro = {
  subtitle: 'A short view of the interests and working style behind the projects.',
  paragraphs: [
...
export const artificialIntelligenceStory = {
  ...
  paragraphs: [
    ...
    'Along the way, I completed KAUST Academy certificates in Introduction to Artificial Intelligence and Advanced Artificial Intelligence. Based on my CV content, I advanced to the final Summer Program after completing the first three stages, ranking among the top 100 students selected from 14,000+ applicants.',
